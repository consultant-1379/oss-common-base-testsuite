...
let body_all_logs = JSON.parse(open('../../../resources/data/log_viewer_body.json'));
//All Logs of last 30min
body_all_logs['options']['timeRange']['start'] = 1800000;
body_all_logs['options']['timeRange']['end'] = 0;
...
export function logViewerCharacteristicsWithJSessionEnv(data) {
  ...
  group("Use Case: Concurrent Users - Get Logs with Login Auth Flow", function () {
    ...
    group("Get Logs", function() {
      response = newUser.get_logs_logViewer(jSessionId,body_all_logs);
    });
...
export function logViewerCharacteristicsWithClientSecretEnv(data) {
  ...
  group("Use Case: Concurrent Users - Get Logs with Client Secret Flow", function () {
    ...
    group("Get Logs", function() {
      response = ClientSecretFlow.getAllLogs(tokenSecret,refreshToken,body_all_logs);
    });
