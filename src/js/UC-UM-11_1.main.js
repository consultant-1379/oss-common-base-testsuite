...
//Test Cases
import { setupEnv, usermgmtKpiEnvEnableDisableClients,
    usermgmtKpiEnvGetAllExternalClients, usermgmtKpiEnvGetClientsSecret,
    usermgmtKpiEnvUpdateRealmRoles, usermgmtKpiEnvViewRoleMapping,
    usermgmtKpiEnvGetProtocolMapper, usermgmtKpiEnvCreateProtocolMapper,
    usermgmtKpiEnvGetProtocolMapperByAttribute,
    usermgmtKpiEnvUpdateProtocolMapper, usermgmtKpiEnvDeleteProtocolMapper,
    usermgmtKpiEnvGetClaims, usermgmtKpiEnvGetClientByAttribute,
    usermgmtKpiEnvRegenerateClientsSecret, teardownEnv } from './use_cases/userManagement/UC-UM-11_1.js'
...
export function usermgmtKpiGetClientByAttribute(data) {
    usermgmtKpiEnvGetClientByAttribute(data);
}
...
export function usermgmtKpiGetProtocolMapperByAttribute(data) {
    usermgmtKpiEnvGetProtocolMapperByAttribute(data);
}
...
export function handleSummary(data) {
    return {
        //'./reports/result_UC-UM-11_1_ClientSecret.html' : htmlReport(data),
        './reports/result_UC-UM-11_1_ClientSecret.json': JSON.stringify(data),
