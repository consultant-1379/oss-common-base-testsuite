...
export function setupEnv() {
  ...
  group("Enable BFP: set MaxLoginFailures, MaxFailureWaitSeconds, MaxDeltaTimeSeconds", function () {
    ...
    bfProtection.setMaxFailureWaitSeconds(10);
...
export function loginMaxWaitExpired(data) {
...
export function teardownEnv(data) {
  ...
  // Step7 Failed login attempts
  group("Login attempt after MaxFailureWaitSeconds: new user should not be locked", function () {
    newUser.login();
  });
